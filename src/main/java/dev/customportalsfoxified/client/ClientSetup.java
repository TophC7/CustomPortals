...
@EventBusSubscriber(modid = CustomPortalsFoxified.MOD_ID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.MOD)
public class ClientSetup {
    ...
    public static void onClientSetup(FMLClientSetupEvent event) {
        event.enqueueWork(() -> {
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.CUSTOM_PORTAL.get(), RenderType.translucent());
            ...
            ItemBlockRenderTypes.setRenderLayer(ModBlocks.STRONG_ENHANCER_RUNE.get(), RenderType.cutout());
