...
public class CustomPortal {
    ...
    public CustomPortal(UUID id, DyeColor color, ResourceLocation frameMaterial,
                        ResourceKey<Level> dimension, BlockPos spawnPos,
                        Set<BlockPos> portalBlocks, @Nullable UUID creatorId) {
        this.id = id;
        this.color = color;
    ...
    public ResourceLocation getFrameMaterial() { return frameMaterial; }
    public ResourceKey<Level> getDimension() { return dimension; }
    public BlockPos getSpawnPos() { return spawnPos; }
    public Set<BlockPos> getPortalBlocks() { return portalBlocks; }
    public @Nullable UUID getCreatorId() { return creatorId; }
    public @Nullable UUID getLinkedPortalId() { return linkedPortalId; }
    public @Nullable ResourceKey<Level> getLinkedDimension() { return linkedDimension; }

    public boolean isLinked() { return linkedPortalId != null; }
    public boolean hasHaste() { return hasHaste; }
    public boolean hasGate() { return hasGate; }
    public boolean hasInfinity() { return hasInfinity; }
    ...
    public static CustomPortal load(CompoundTag tag) {
        ...
        CustomPortal portal = new CustomPortal(
                id, color, frameMaterial, dimension, spawnPos, portalBlocks, creatorId);

        if (tag.contains("linkedPortalId")) {
            portal.linkedPortalId = tag.getUUID("linkedPortalId");
            portal.linkedDimension = ResourceKey.create(
                    net.minecraft.core.registries.Registries.DIMENSION,
